...
public interface InterfaceFuncionRepository extends JpaRepository<Funcion, Integer>{
    ...
    // f.sala.id "f" es la funcion, "sala" la sala dentro de la funcion, "id" aca solo se tiene que poner id 
    //para  referirse a la id_sala de mi base de datos no hace falta el nombre verdadero de la columna id_sala 
